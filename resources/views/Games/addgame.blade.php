        ...
        <div class="container-fluid">
            <section class="content p-3">
                ...
                <div class="card mx-2 shadow">
                    ...
                    <!-- /.card-body -->
                    <div class="card-body">
                        <form action="{{ route('games.save') }}" method="post" class="form">
                            @csrf
                            <div class="row">
                                <div class="col">
                                    <label>Game Title:<span class="text-danger">*</span></label>
                                    <input class="form-control" type="text" name="game_title" placeholder="Game Title">
                                    @error('game_title')
                            ...
                            <div class="col">
                                ...
                                <textarea name="content1" id="htmlEditor1" class="form-control"></textarea>
                                @error('content1')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col">
                                ...
                                <textarea name="content2" id="htmlEditor2" class="form-control"></textarea>
                                @error('content2')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
